<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="检测地点" prop="jiancedidian">
          <el-input v-model="ruleForm.jiancedidian" 
              placeholder="检测地点" clearable  :readonly="ro.jiancedidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="检测地点" prop="jiancedidian">
              <el-input v-model="ruleForm.jiancedidian" 
                placeholder="检测地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="检测时间" prop="jianceshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jianceshijian" label="检测时间" prop="jianceshijian">
              <el-input v-model="ruleForm.jianceshijian" 
                placeholder="检测时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.banji = true;
          ...
          if(o=='jiancedidian'){
            this.ruleForm.jiancedidian = obj[o];
	    this.ro.jiancedidian = true;
            continue;
          }
          if(o=='jianceshijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `hesuanbaogao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.hesuanbaogaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
