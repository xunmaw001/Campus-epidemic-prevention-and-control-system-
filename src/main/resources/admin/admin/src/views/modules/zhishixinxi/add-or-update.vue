    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="知识类型" prop="zhishileixing">
          <el-input v-model="ruleForm.zhishileixing" 
              placeholder="知识类型" clearable  :readonly="ro.zhishileixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="知识简介" prop="zhishijianjie">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhishijianjie" label="知识简介" prop="zhishijianjie">
                    <span>{{ruleForm.zhishijianjie}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhishineirong" label="知识内容" prop="zhishineirong">
                    <span v-html="ruleForm.zhishineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zhishineirong = this.ruleForm.zhishineirong.replace(reg,'../../../springbootm94q1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
