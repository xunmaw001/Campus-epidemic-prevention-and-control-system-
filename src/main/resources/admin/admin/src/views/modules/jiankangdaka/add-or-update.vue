<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="身体情况" prop="shentiqingkuang">
          <el-select :disabled="ro.shentiqingkuang" v-model="ruleForm.shentiqingkuang" placeholder="请选择身体情况">
            <el-option
                v-for="(item,index) in shentiqingkuangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="身体情况" prop="shentiqingkuang">
	      <el-input v-model="ruleForm.shentiqingkuang"
                placeholder="身体情况" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="接触史" prop="jiechushi">
          <el-select :disabled="ro.jiechushi" v-model="ruleForm.jiechushi" placeholder="请选择接触史">
            <el-option
                v-for="(item,index) in jiechushiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="接触史" prop="jiechushi">
	      <el-input v-model="ruleForm.jiechushi"
                placeholder="接触史" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  created() {
	this.ruleForm.dakashijian = this.getCurDate()
