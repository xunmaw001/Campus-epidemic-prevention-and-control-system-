<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="回来时间" prop="huilaishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.huilaishijian" 
                type="datetime"
                :readonly="ro.huilaishijian"
                placeholder="回来时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huilaishijian" label="回来时间" prop="huilaishijian">
              <el-input v-model="ruleForm.huilaishijian" 
                placeholder="回来时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="相关地点" prop="xiangguandidian">
          <el-input v-model="ruleForm.xiangguandidian" 
              placeholder="相关地点" clearable  :readonly="ro.xiangguandidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="相关地点" prop="xiangguandidian">
              <el-input v-model="ruleForm.xiangguandidian" 
                placeholder="相关地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huilaishijian = true;
          ...
          if(o=='xiangguandidian'){
            this.ruleForm.xiangguandidian = obj[o];
	    this.ro.xiangguandidian = true;
            continue;
          }
          if(o=='qingjiashiyou'){
