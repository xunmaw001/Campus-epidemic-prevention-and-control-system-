<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="城市地区" prop="chengshidiqu">
          <el-input v-model="ruleForm.chengshidiqu" 
              placeholder="城市地区" clearable  :readonly="ro.chengshidiqu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="城市地区" prop="chengshidiqu">
              <el-input v-model="ruleForm.chengshidiqu" 
                placeholder="城市地区" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="新增病例" prop="xinzengbingli">
          <el-input v-model="ruleForm.xinzengbingli" 
              placeholder="新增病例" clearable  :readonly="ro.xinzengbingli"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="新增病例" prop="xinzengbingli">
              <el-input v-model="ruleForm.xinzengbingli" 
                placeholder="新增病例" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="累计确诊" prop="leijiquezhen">
          <el-input v-model="ruleForm.leijiquezhen" 
              placeholder="累计确诊" clearable  :readonly="ro.leijiquezhen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="累计确诊" prop="leijiquezhen">
              <el-input v-model="ruleForm.leijiquezhen" 
                placeholder="累计确诊" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="治愈人数" prop="zhiyurenshu">
          <el-input v-model="ruleForm.zhiyurenshu" 
              placeholder="治愈人数" clearable  :readonly="ro.zhiyurenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="治愈人数" prop="zhiyurenshu">
              <el-input v-model="ruleForm.zhiyurenshu" 
                placeholder="治愈人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="死亡人数" prop="siwangrenshu">
          <el-input v-model="ruleForm.siwangrenshu" 
              placeholder="死亡人数" clearable  :readonly="ro.siwangrenshu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="死亡人数" prop="siwangrenshu">
              <el-input v-model="ruleForm.siwangrenshu" 
                placeholder="死亡人数" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='chengshidiqu'){
            this.ruleForm.chengshidiqu = obj[o];
	    this.ro.chengshidiqu = true;
            continue;
          }
          if(o=='xinzengbingli'){
            this.ruleForm.xinzengbingli = obj[o];
	    this.ro.xinzengbingli = true;
            continue;
          }
          if(o=='leijiquezhen'){
            this.ruleForm.leijiquezhen = obj[o];
	    this.ro.leijiquezhen = true;
            continue;
          }
          if(o=='zhiyurenshu'){
            this.ruleForm.zhiyurenshu = obj[o];
	    this.ro.zhiyurenshu = true;
            continue;
          }
          if(o=='siwangrenshu'){
            this.ruleForm.siwangrenshu = obj[o];
	    this.ro.siwangrenshu = true;
            continue;
          }
          if(o=='dengjishijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yiqingdongtai/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yiqingdongtaiCrossAddOrUpdateFlag = false;
						 this.parent.search();
